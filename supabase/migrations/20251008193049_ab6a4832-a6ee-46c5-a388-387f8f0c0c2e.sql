...
-- Recriar a função de criação de usuário com username
DROP FUNCTION IF EXISTS public.create_user_with_username(text, text, text);
...
BEGIN
  ...
  -- Cria o usuário no auth.users usando a extensão pgcrypto
